...
The code of TO-DO-IQ is based only on pythons default modules, meaning no extra installation is required. It is naturally divided into three, largely indepent layers + a setup procedure, each with its own dedicated .py file:
