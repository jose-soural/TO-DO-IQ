...
p_delete.add_argument("target_task", help="The task to be deleted. Can be its name or its index as listed in the last displayed list.")
...
p_rename.add_argument("target_task", help="The task to undergo name change. Can be its name or its index as listed in the last displayed list.")
p_rename.add_argument("new_name", type=make_name, help="The new name for the task. Underscores ('_') will be turned into spaces.")
...
p_refreq.add_argument("target_task", help="The task to undergo frequency change. Can be its name or its index as listed in the last displayed list.")
p_refreq.add_argument("new_frequency", help="The new frequency for the task.")
...
p_redescr.add_argument("target_task", help="The task to undergo description change. Can be its name or its index as listed in the last displayed list.")
p_redescr.add_argument("new_description", nargs="*", type=make_description, help="The new description for the task.")
...
p_set_asleep.add_argument("target_task", help="The task to be put to sleep. Can be its name or its index as listed in the last displayed list.")
...
p_set_due.add_argument("target_task", help="The task to be put to renewed. Can be its name or its index as listed in the last displayed list.")
...
p_set_due.add_argument("target_task", help="The task to be put to made overdue. Can be its name or its index as listed in the last displayed list.")
...
p_set_fin.add_argument("target_task", help="The task to be put to made overdue. Can be its name or its index as listed in the last displayed list.")
...
p_descr.add_argument("target_task", help="The task whose description is to be shown. Can be its name or its index as listed in the last displayed list.")
p_descr.set_defaults(func=description)

p_detail = commands.add_parser("detail", help="Displays all information about the task.")
p_detail.add_argument("target_task", help="The task whose information is to be shown. Can be its name or its index as listed in the last displayed list.")
...
settings.add_argument("--list", "-l", dest="option", action="store_true", help="Displays a list of changeable settings")
settings.add_argument("--auto_refresh", dest="option", type=casefold, choices=["true", "false"], help="Toggle whether you want the program to automatically refresh the to-do list upon booting. (Default = False)")
